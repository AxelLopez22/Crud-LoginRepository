...
namespace EjercicioDB2.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=JADPA-11\\SQLSERVER2019;Database=AdventureWorks2019;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
